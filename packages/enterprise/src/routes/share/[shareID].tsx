import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@codepwn-ai/sdk/v2"
import { SessionTurn } from "@codepwn-ai/ui/session-turn"
import { SessionReview } from "@codepwn-ai/ui/session-review"
import { DataProvider } from "@codepwn-ai/ui/context"
import { DiffComponentProvider } from "@codepwn-ai/ui/context/diff"
import { CodeComponentProvider } from "@codepwn-ai/ui/context/code"
import { WorkerPoolProvider } from "@codepwn-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@codepwn-ai/ui/logo"
import { IconButton } from "@codepwn-ai/ui/icon-button"
import { ProviderIcon } from "@codepwn-ai/ui/provider-icon"
import { createDefaultOptions } from "@codepwn-ai/ui/pierre"
import { iife } from "@codepwn-ai/util/iife"
import { Binary } from "@codepwn-ai/util/binary"
...
import { MessageNav } from "@codepwn-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@codepwn-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@codepwn-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@codepwn-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@codepwn-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@codepwn-ai/ui/pierre/worker").then((m) => ({
