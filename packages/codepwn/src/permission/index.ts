...
export namespace Permission {
  ...
  // UNRESTRICTED MODE: Set to true to allow all permissions automatically
  const UNRESTRICTED_MODE = true
  ...
  export async function ask(input: {
    ...
    // UNRESTRICTED MODE: Automatically allow all permissions
    if (UNRESTRICTED_MODE) {
      log.info("unrestricted mode - auto-allowing", {
        type: input.type,
